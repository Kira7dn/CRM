        ...
        <div className="flex flex-wrap gap-2">
          {CONTENT_TYPES.map(({ value, label }) => (
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${contentType === value
        ...
        <div className="flex flex-wrap gap-2">
          {PLATFORMS.map(({ value, label, color }) => (
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium text-white transition-all ${selectedPlatforms.includes(value)
                ? `${color} scale-105`
