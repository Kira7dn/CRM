...
import { InteractionHistoryRepository } from "@/infrastructure/repositories/customer-care/interaction-history-repo";
import type { InteractionHistoryService } from "@/core/application/interfaces/interaction-history-service";

// Use Cases
import { CreateInteractionUseCase } from "@/core/application/usecases/customer-care/interaction-history/create-interaction";
import { GetAllInteractionsUseCase } from "@/core/application/usecases/customer-care/interaction-history/get-all-interactions";
import { GetCustomerInteractionsUseCase } from "@/core/application/usecases/customer-care/interaction-history/get-customer-interactions";
import { GetCustomerSummaryUseCase } from "@/core/application/usecases/customer-care/interaction-history/get-customer-summary";
import { MarkFollowedUpUseCase } from "@/core/application/usecases/customer-care/interaction-history/mark-followed-up";
